...
export const logout = () => async (dispatch) => {
  try {
    ...
    await localStorage.removeItem("userinfovkname",data.user.name )
    await localStorage.removeItem("userinfovkaccno",data.user.acc_no )
    await localStorage.removeItem("userinfovkphoneno",data.user.phoneNumber )
    await localStorage.removeItem("userinfovkemail",data.user.email )
